...
func (decoder) BytesToUint16(endianness Endianness, in []byte) uint16 {
	return bytesToUint16(endianness, in)
}

func (decoder) BytesToUint16s(endianness Endianness, in []byte) []uint16 {
	return bytesToUint16s(endianness, in)
}

func (decoder) BytesToUint32s(endianness Endianness, wordOrder WordOrder, in []byte) []uint32 {
	return bytesToUint32s(endianness, wordOrder, in)
}

func (decoder) BytesToFloat32s(endianness Endianness, wordOrder WordOrder, in []byte) []float32 {
	return bytesToFloat32s(endianness, wordOrder, in)
}

func (decoder) BytesToUint64s(endianness Endianness, wordOrder WordOrder, in []byte) []uint64 {
	return bytesToUint64s(endianness, wordOrder, in)
}
