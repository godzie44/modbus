...
func (eh *exampleHandler2) HandleHoldingRegisters(req *modbus.HoldingRegistersRequest) (res []uint16, err error) {
	var regAddr uint16
...
func (eh *exampleHandler2) HandleInputRegisters(req *modbus.InputRegistersRequest) (res []uint16, err error) {
...
func (eh *exampleHandler2) HandleCoils(req *modbus.CoilsRequest) (res []bool, err error) {
	// this is the equivalent of saying
...
func (eh *exampleHandler2) HandleDiscreteInputs(req *modbus.DiscreteInputsRequest) (res []bool, err error) {
	// this is the equivalent of saying
